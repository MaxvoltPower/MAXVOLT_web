...
export default function SolutionsSection() {
  ...
  return (
    <section id="solutions" className="light-bg">
      ...
      <div className="surface text-center mb-10">
        <h3 className="mb-3">Inverter + Battery = Complete Backup Solution</h3>
        <p className="mb-5">
          An inverter converts DC power from a battery to AC power for your home appliances.
          Together, they provide seamless backup during power cuts.
        </p>
        <Link
          to="/#calculator"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {capacities.map((c) => (
          <div
            key={c.label}
            className="text-center p-6 rounded-2xl bg-dark-elevated border border-dark-border hover:-translate-y-1 hover:shadow-md hover:border-accent transition-all"
          >
            <h4 className="mb-2">{c.label}</h4>
      ...
      <div className="text-center">
        <Link
          ...
          className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-gradient-to-br from-primary-light to-primary text-white text-lg font-semibold hover:shadow-lg hover:-translate-y-0.5 transition-all"
        >
